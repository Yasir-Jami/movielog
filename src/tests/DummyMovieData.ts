...
function testMovieArray(): MovieMetadata[] {
  let movieArray: MovieMetadata[] = [];

  // Test values
  const movie1: MovieMetadata = {
    Title: "The Matrix",
